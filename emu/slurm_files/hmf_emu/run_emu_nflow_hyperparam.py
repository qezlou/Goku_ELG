...
def _build_objective(args, base_config: Dict[str, Any]):
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        emu, _, _ = run_it(
            ...
            lf_finetune_on_hf=trial_cfg.get('lf_finetune_on_hf', False),
            lf_finetune_max_iters=trial_cfg.get('lf_finetune_max_iters', 500),
            lf_finetune_lr=trial_cfg.get('lf_finetune_lr', trial_cfg.get('lf_mean_lr', 1e-3)),
            lf_finetune_batch_size=trial_cfg.get('lf_finetune_batch_size', trial_cfg.get('lf_mean_batch_size', 128)),
